...
//!
//! **Migration Path**:
//! - Old: Global with f64 fees (non-deterministic, not used)
//! - New: Config with u64 BPS fees (deterministic, actively used)
//!
//! **Current Usage**: NONE - This file is kept only for historical reference
//! **Action Required**: Can be safely removed in v2.0 (requires cleanup commit)
//!
//! **Key Differences**:
